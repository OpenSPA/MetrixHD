...
"""
	...
	def getMenuItemList(self):
		...
		if config.plugins.MetrixWeather.enabled.getValue() is True:
			...
			list.append(getConfigListEntry(_("MetrixWeather ID"), config.plugins.MetrixWeather.woeid , _("Get your local MetrixWeather ID from http://weather.mynonpublic.com/locationid.html")))
